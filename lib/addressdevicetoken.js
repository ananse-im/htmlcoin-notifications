...
function AddressDeviceTokenController(options) {
    ...
    pushyAPI = new Pushy(options.pushySecretApiKey);
...
AddressDeviceTokenController.prototype.sendNotification = function(addr, txid, type) {
    this.sendFirebaseNotification(addr, txid, type);
    // this.sendPushyNotification(addr, txid, type);
}

AddressDeviceTokenController.prototype.sendFirebaseNotification = function(addr, txid, type) {
    var self = this;

    // look up device token from address
    this.addressDeviceTokenService.getDeviceTokenByAddress(addr, function(deviceToken){
...
AddressDeviceTokenController.prototype.sendPushyNotification = function(addr, txid, type) {
    var self = this;
    this.addressDeviceTokenService.getPushyDeviceTokenByAddress(addr, function(deviceToken){
        if (deviceToken == null || deviceToken == "") return;
